# <p align="center"> Isometric 2D Map (study)</p>

## Описание проекта

Данный проект является изучением плагина MapBox.
...
**Основная задача проекта** - Изучение возможностей плагина MapBox в Unity3D.
